...
public class Pathfinding : MonoBehaviour {
    ...
    MoveObjectToTarget MoveObjectReference;
    ...
    {
        MoveObjectReference = GetComponent<MoveObjectToTarget>();//Get a reference to the game manager
    ...
    private void Update()//Every frame
    {
        ...
        //        FindPath(StartPosition.position, ray.GetPoint(distance));//Find a path to the goal
        //    }
